...
<body>
  ...
  <div class="form-container centered-form">
    ...
    <form action="UpdateStdServlet" method="post">
      <div class="mb-3">
        <label for="std_id" class="form-label">Student ID</label>
        <input type="text" class="form-control" id="std_id" name="sid" value="<%=sid%>" readonly>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="password" class="form-control" id="password" name="pass" value="<%=pass%>">
      </div>
